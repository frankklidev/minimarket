    ...
    <header className="bg-primary text-neutralLight p-4 shadow-lg">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <nav className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 text-center mb-4 md:mb-0">
          ...
          <Link href="/categories" className="text-secondary hover:text-accent">
            Nuestros Productos
          </Link>
          <Link href="/contacto" className="text-secondary hover:text-accent">
            Contacto
          </Link>
        </nav>
        ...
        <div className="relative">
          <div className="flex items-center bg-white rounded-full px-3 py-1">
            ...
            />
            {loading && <Loader className="animate-spin text-gray-500 ml-2" size={18} />}
          </div>
        ...
        <div className="flex items-center text-center space-x-2 md:space-x-4">
          <Link
            href="/cart"
            className="text-secondary hover:text-accent flex items-center"
          >
