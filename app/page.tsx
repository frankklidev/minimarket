...
const HomePage = () => {
    ...
    <MainContent>
      <section className="text-center py-10">
        ...
        <Link href="/categories" passHref>
          <button className="px-8 py-3 bg-primary text-white rounded-full font-semibold text-lg shadow-lg hover:bg-primary-dark transition-all duration-300">
  ...
  <div className="max-w-4xl mx-auto text-center">
    ...
    <p className="text-white mb-6 text-lg">
      Aprovecha nuestras ofertas exclusivas en productos seleccionados. ¡No te las pierdas!
    </p>
